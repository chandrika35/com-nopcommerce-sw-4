...
public class ComputerTest extends BaseTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        checkoutPage.sendFirstName("Donna");
        checkoutPage.sendLastName("Regan");
        checkoutPage.sendEmail("donaldregan_123@gmail.com");
        checkoutPage.selectCountryName("United Kingdom");
        checkoutPage.sendCityName("London");
        checkoutPage.sendAddressName("111,Worcester Avenue");
        checkoutPage.sendPostCode("SW11 3PQ");
        checkoutPage.sendPhoneNumber("0765443689");
        ...
        checkoutPage.selectCardType("American Express");
        //2.28 Fill all the details
        checkoutPage.sendCardholderName("Mrs.Donna Regan");
        checkoutPage.sendCardNumber("789000023450068");
        checkoutPage.selectExpiryMonth("12");
        checkoutPage.selectExpiryYear("2030");
        checkoutPage.sendCVVCode("432");
