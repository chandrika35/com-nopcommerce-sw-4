...
public class ElectronicsTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        Thread.sleep(1000);
        registerPage.enterFirstName("Donna");
        Thread.sleep(200);
        registerPage.enterLastName("Regan");
        Thread.sleep(200);
        registerPage.enterEmail("donna_Regan345@gmail.com");
        Thread.sleep(200);
        registerPage.enterPassword("regan234");
        Thread.sleep(200);
        registerPage.enterConfirmPassword("regan234");
        Thread.sleep(200);
